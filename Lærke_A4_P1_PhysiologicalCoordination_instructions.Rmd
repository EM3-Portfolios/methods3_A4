...
data_lists$Task <- str_replace_all(data_lists$Task, c("elfPaced" = "SelfPaced", "rnTaking" = "TurnTaking", "chronous" = "Synchronous", "ersation" = "Conversation", "ntGuided" = "MovementGuided", "mentCoop" = "MovementCoop"))
