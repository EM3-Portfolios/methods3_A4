...
# The model:
HR_m1 <- lmerTest::lmer(HR_self_change ~ (HR_self + diff) : Task + (1 + Task | ParticipantID), subset(dlong, Study == "3"), REML = F, control = lmerControl(optimizer = "nloptwrap", calc.derivs = F))
...
HR_m1_shuff <- lmerTest::lmer(HR_self_change ~ 0+ ((HR_self + diff) : Task) : Control + (1 + Task | ParticipantID), subset(dlonger, Study == "3"), REML = F, control = lmerControl(optimizer = "nloptwrap", calc.derivs = F))
...
HR_m1_surrogate <- lmerTest::lmer(HR_self_change ~ 0+ (HR_self + diff) : Task : Type + (1 + Task | ParticipantID), subset(dlong_surrogate, Study == "2"), REML = F, control = lmerControl(optimizer = "nloptwrap", calc.derivs = F))

summary(HR_m1_surrogate)
