...
# Load the file
singlefile <- readr::read_csv("Study1_G1_T1_Synchronous.csv",
...
# Plot
plot_raw <- ggplot(data = singlefile) +
...
singlefile_noOuts <- singlefile
singlefile_noOuts <- singlefile_noOuts %>%
...
plot_noOuts <- ggplot(data = singlefile_noOuts) +
  geom_path(aes(time, HR1_c, colour = "P1")) +
  geom_path(aes(time, HR2_c, colour = "P2")) + 
  labs(x = "time", y = "HR") + 
  theme_classic() +
  ggtitle("Data with no Outliers")
...
## Scale
singlefile_noOuts$Resp1S <- scale(singlefile_noOuts$Resp1_c)
singlefile_noOuts$Resp2S <- scale(singlefile_noOuts$Resp2_c)
singlefile_noOuts$HR1S <- scale(singlefile_noOuts$HR1_c)
singlefile_noOuts$HR2S <- scale(singlefile_noOuts$HR2_c)
...
plot_noOuts_scaled <- ggplot(data = singlefile_noOuts) +
  geom_path(aes(time, HR1S, colour = "P1")) +
  geom_path(aes(time, HR2S, colour = "P2")) + 
  labs(x = "time", y = "HR") + 
  theme_classic() + 
  ggtitle("Scaled Data with no Outliers")
