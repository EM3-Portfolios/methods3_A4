...
filenames_list <- list.files(path = "/Users/laerkebraedder/Desktop/Uni/ExpMeth3/Assignment/methods3_A4/data/", pattern = "*.csv")
...
d1$HR1_lead <- stats::lag(d1$HR1, -1)
d1$HR2_lead <- stats::lag(d1$HR2, -1)

d1$Resp1_lead <- stats::lag(d1$Resp1, -1)
d1$Resp2_lead <- stats::lag(d1$Resp2, -1)

# Generate a column for each: change in HR1, HR2, Resp1, Resp2
d1$HR1_change <- d1$HR1_lead - d1$HR1
d1$HR1_change <- d1$HR1_lead - d1$HR1
