...
data_preprocess <- function(filename, threshold = 2.5){
  ...
  #loading data
  d <- read_csv(paste0("lille_data/", filename))
...
filenames_list <- list.files(path = "/Users/manon/Desktop/3. Semester/Experimental Methods 3/EM3 portfolio 4/methods3_A4/lille_data/", pattern = "*.csv")
